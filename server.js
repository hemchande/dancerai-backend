...
const io = new Server(server, {
  cors: {
    origin: "https://dancerai-backend.onrender.com",
    methods: ["GET", "POST"],
    credentials: true
  }
});
...
app.use(cors({
  origin: 'https://dancerai-backend.onrender.com', // Set the allowed origin for requests http://localhost:3000 https://connectarts-frontend-2.onrender.com
  credentials: true
}));

app.use(function(req, res, next) {
  res.header('Access-Control-Allow-Origin', 'https://dancerai-backend.onrender.com');// http://localhost:3000 https://connectarts-frontend-2.onrender.com
